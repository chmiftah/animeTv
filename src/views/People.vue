<template>
  <div class="home bg-gray-800 px-4 py-6 ">
    <div class="">
      <div class="text-white text-4xl font-semibold p-4">
        <span class="border-b border-gray-400 p-1">Top People </span>
      </div>
  ...
  methods:{
    async fetchTop(){
        this.loadingStatus = true
         let response= await axios.get(`https://api.jikan.moe/v3/anime/1/news`)
